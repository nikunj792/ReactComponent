...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReactForm = __webpack_require__(159);

	ReactDOM.render(React.createElement(ReactForm, null), document.getElementById('reactForm'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactMessage = __webpack_require__(160);

	var ReactForm = React.createClass({
		displayName: 'ReactForm',

		onPersonalFormSubmit: function onPersonalFormSubmit(e) {
			e.preventDefault();
		...
		onProfileFormSubmit: function onProfileFormSubmit(e) {
			e.preventDefault();
			var profile = {};
	   ...
	   profile.company:company,
		...
		handleProfile: function handleProfile(profile) {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						null,
						React.createElement('input', { type: 'text', ref: 'fname' })
					),
					React.createElement(
						'div',
						null,
					...
					React.createElement(
						'div',
						null,
						React.createElement('input', { type: 'text', ref: 'lname' })
					),
					React.createElement(
						'div',
						null,
				...
				React.createElement(
					...
					React.createElement(
						'div',
						null,
						React.createElement('input', { type: 'text', ref: 'company' })
					),
					React.createElement(
						'div',
						null,
				...
				React.createElement(ReactMessage, { onProfile: this.handleProfile })
			);
		}
	});
